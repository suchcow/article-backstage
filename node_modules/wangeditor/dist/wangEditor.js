...
var _every = _interopRequireDefault(__webpack_require__(407));
...
var stack_1 = __webpack_require__(427);
...
var init_dom_1 = __importDefault(__webpack_require__(413));

var init_selection_1 = __importDefault(__webpack_require__(414));

var bind_event_1 = __importDefault(__webpack_require__(415));

var i18next_init_1 = __importDefault(__webpack_require__(416));

var set_full_screen_1 = __importStar(__webpack_require__(417));

var scroll_to_head_1 = __importDefault(__webpack_require__(420));

var z_index_1 = __importDefault(__webpack_require__(421));

var index_3 = __importDefault(__webpack_require__(422));

var index_4 = __importDefault(__webpack_require__(424));

var disable_1 = __importDefault(__webpack_require__(434));
  ...
  SelectionAndRange.prototype.recordSelectionNodes = function ($node, $endElem) {
    ...
    while (isEnd) {
      ...
      if ($elem.length > 0) {
        ...
        if ($endElem === null || $endElem === void 0 ? void 0 : $endElem.equal($elem)) {
          isEnd = false;
        } else {
    ...
    try {
      ...
      if (isCssStyle && pasteFilterStyle) {
        ...
        if (isParagraphHtml(html)) {
          ...
          $textEl.append(dom_core_1["default"](html)); // 如果选区是空段落，移除空段落
...
var code_1 = __importDefault(__webpack_require__(398));

var index_21 = __importDefault(__webpack_require__(403));

var todo_1 = __importDefault(__webpack_require__(406));
...
var paste_img_1 = __importDefault(__webpack_require__(361));

var drop_img_1 = __importDefault(__webpack_require__(362));

var drag_size_1 = __importDefault(__webpack_require__(363));

var tooltip_event_1 = __importDefault(__webpack_require__(371));
/**
 * 绑定事件
 * @param editor 编辑器实例
 */
...
var _parseFloat2 = _interopRequireDefault(__webpack_require__(364));
...
var $ = __webpack_require__(6);
var parseFloatImplementation = __webpack_require__(368);
...
var index_1 = __importDefault(__webpack_require__(394));
...
var create_table_1 = __importDefault(__webpack_require__(393));
...
var tooltip_event_1 = __importDefault(__webpack_require__(395));
/**
 * 绑定事件
 * @param editor 编辑器实例
 */
...
var operating_event_1 = __importDefault(__webpack_require__(396));

var getNode_1 = __importDefault(__webpack_require__(397));
/**
 * 生成 Tooltip 的显示隐藏函数
 */
...
var create_panel_conf_1 = __importDefault(__webpack_require__(399));

var is_active_1 = __importDefault(__webpack_require__(138));

var Panel_1 = __importDefault(__webpack_require__(32));

var index_1 = __importDefault(__webpack_require__(400));
...
var tooltip_event_1 = __importDefault(__webpack_require__(401));

var jump_code_block_down_1 = __importDefault(__webpack_require__(402));
/**
 * 绑定事件
 * @param editor 编辑器实例
 */
...
var index_1 = __importDefault(__webpack_require__(404));
...
var tooltip_event_1 = __importDefault(__webpack_require__(405));
/**
 * 绑定事件
 * @param editor 编辑器实例
 */
...
var bind_event_1 = __importDefault(__webpack_require__(412));
...
var every = __webpack_require__(410);
...
var mutation_1 = __importDefault(__webpack_require__(423));
...
var content_1 = __importDefault(__webpack_require__(425));
...
var node_1 = __importDefault(__webpack_require__(426));
...
var compile_1 = __importDefault(__webpack_require__(428));

var decompilation_1 = __webpack_require__(429);
